local internalNpcName = "flora_bullwark"
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "fight") then
		npcHandler:say("Do you really want to enter the Bullwark's hideout. There is no chickening out and I also have to charge one voting right! {Yes} or {no}?", npc, creature)
