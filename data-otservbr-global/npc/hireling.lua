		...
		elseif npcHandler:getTopic(playerId) == TOPIC.SERVICES then
			...
			elseif MsgContains(message, "goods") then
				...
				if not hireling:hasSkill(HIRELING_SKILLS.TRADER) then
					...
					string = "I sell a selection of {various} items, {exercise weapons}, {equipment}, " .. "{distance} weapons, {wands} and {rods}, {potions}, {runes}, " .. "{supplies}, {tools}, {postal} and {pouch} goods. Just ask!"
				end
