...
keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, text = "I can bring you either to the {east} end of Port Hope or to the {centre} of the town, where would you like to go?" })
keywordHandler:addKeyword({ "travel" }, StdModule.say, { npcHandler = npcHandler, text = "I can bring you either to the {east} end of Port Hope or to the {centre} of the town, where would you like to go?" })
