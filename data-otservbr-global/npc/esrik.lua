...
npcConfig.shop = {
	...
	-- 3 tomes
	{ itemName = "lizard weapon rack kit", clientId = 10210, buy = 500, storageKey = tomes, storageValue = 0 },
	-- 9 tomes
	{ itemName = "broken halberd", clientId = 10418, sell = 100, storageKey = tomes, storageValue = 0 },
	{ itemName = "spiked iron ball", clientId = 10408, sell = 100, storageKey = tomes, storageValue = 0 },
	{ itemName = "Broken Slicer", clientId = 11661, sell = 120, storageKey = tomes, storageValue = 0 },
	{ itemName = "high guard's shoulderplates", clientId = 10416, sell = 130, storageKey = tomes, storageValue = 0 },
	{ itemName = "bone shoulderplate", clientId = 10404, sell = 150, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaogun's shoulderplates", clientId = 10414, sell = 150, storageKey = tomes, storageValue = 0 },
	{ itemName = "warmaster's wristguards", clientId = 10405, sell = 200, storageKey = tomes, storageValue = 0 },
	{ itemName = "cursed shoulder spikes", clientId = 10410, sell = 320, storageKey = tomes, storageValue = 0 },
	{ itemName = "broken draken mail", clientId = 11660, sell = 340, storageKey = tomes, storageValue = 0 },
	{ itemName = "draken wristbands", clientId = 11659, sell = 430, storageKey = tomes, storageValue = 0 },
	{ itemName = "twin hooks", clientId = 10392, sell = 500, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaoan halberd", clientId = 10406, sell = 500, storageKey = tomes, storageValue = 0 },
	{ itemName = "wailing widow's necklace", clientId = 10412, sell = 3000, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaoan shoes", clientId = 10386, sell = 5000, storageKey = tomes, storageValue = 0 },
	{ itemName = "drachaku", clientId = 10391, sell = 10000, storageKey = tomes, storageValue = 0 },
	{ itemName = "drakinata", clientId = 10388, sell = 10000, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaoan armor", clientId = 10384, sell = 14000, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaoan legs", clientId = 10387, sell = 14000, storageKey = tomes, storageValue = 0 },
	{ itemName = "sai", clientId = 10389, sell = 16500, storageKey = tomes, storageValue = 0 },
	{ itemName = "twiceslicer", clientId = 11657, sell = 28000, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaoan sword", clientId = 10390, sell = 30000, storageKey = tomes, storageValue = 0 },
	{ itemName = "guardian boots", clientId = 10323, sell = 35000, storageKey = tomes, storageValue = 0 },
	{ itemName = "draken boots", clientId = 4033, sell = 40000, storageKey = tomes, storageValue = 0 },
	{ itemName = "zaoan helmet", clientId = 10385, sell = 45000, storageKey = tomes, storageValue = 0 },
	{ itemName = "Elite Draken Mail", clientId = 11651, sell = 50000, storageKey = tomes, storageValue = 0 },
}
