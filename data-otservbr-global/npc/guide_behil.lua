...
keywordHandler:addKeyword({ "spell trainers" }, StdModule.say, { npcHandler = npcHandler, text = "You can learn spells from the town spell trainers. Ask me about {world status} if you want to hear about world changes." })
