...
addTravelKeyword("center", "the center of Port Hope", 7, Position(32628, 32771, 7))
...
keywordHandler:addKeyword({ "passage" }, StdModule.say, { npcHandler = npcHandler, text = "I can travel you to {west}, {centre}, {darama}, {chor}, {mountain pass} or {banuta}." })
keywordHandler:addKeyword({ "sail" }, StdModule.say, { npcHandler = npcHandler, text = "I can travel you to {west}, {centre}, {darama}, {chor}, {mountain pass} or {banuta}." })
keywordHandler:addKeyword({ "travel" }, StdModule.say, { npcHandler = npcHandler, text = "I can travel you to {west}, {centre}, {darama}, {chor}, {mountain pass} or {banuta}." })
