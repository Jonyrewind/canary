...
ChestUnique = {
	...
	[6111] = {
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6111,
		time = 24, -- hour
	},
	[6112] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6112,
		time = 24, -- hour
	},
	[6113] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6113,
		time = 24, -- hour
	},
	[6114] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6114,
		time = 24, -- hour
	},
	[6115] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6115,
		time = 24, -- hour
	},
	[6116] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6116,
		time = 24, -- hour
	},
	[6117] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6117,
		time = 24, -- hour
	},
	[6118] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6118,
		time = 24, -- hour
	},
	[6119] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6119,
		time = 24, -- hour
	},
	[6120] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 34160, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.Quest.U12_40.TheOrderOfTheLion.BounacChestsTimer + 6120,
		time = 24, -- hour
	},
	[6121] = {
		itemId = 28828,
		itemPos = { x = 33366, y = 32646, z = 7 },
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6121,
		time = 24, -- hour
	},
	[6122] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6122,
		time = 24, -- hour
	},
	[6123] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6123,
		time = 24, -- hour
	},
	[6124] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6124,
		time = 24, -- hour
	},
	[6125] = {
		itemId = 28828,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6125,
		time = 24, -- hour
	},
	[6126] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6126,
		time = 24, -- hour
	},
	[6127] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6127,
		time = 24, -- hour
	},
	[6128] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6128,
		time = 24, -- hour
	},
	[6129] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6129,
		time = 24, -- hour
	},
	[6130] = {
		itemId = 28827,
		...
		randomReward = { { 9083, 1 }, { 31678, 1 }, { 9058, 1 }, { 6299, 1 }, { 3052, 1 }, { 3035, 10 } },
		reward = { { nil, nil } },
		timerStorage = Storage.GraveDanger.CobraBastion.CobraBastionChestsTimer + 6130,
		time = 24, -- hour
	},
