...
GameStore.Categories = {
	...
	-- Items ~ Tools
	{
		...
		offers = {
			...
			},
			{
				...
				count = 1,
				movable = true,
				description = "<i>Use this knife on a dead war wolf to retrieve some leather. Don't lose it and don't leave the cave</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
	...
	-- Items ~ Backpacks
	{
		...
		offers = {
			...
			{
				icons = { "Pillow_Backpack.png" },
				name = "Pillow Backpack",
				price = 450,
				itemtype = 24393,
				count = 1,
				movable = true,
				description = "<i>This backpack is very light and has a large volume.</i>\n\n{info} Weight: 14.50\n{info}Vol: 24",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
