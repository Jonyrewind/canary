...
GameStore.Categories = {
	...
	-- Items
	{
		...
		name = "Items",
		rookgaard = false,
		subclasses = { "Backpacks", "Tools", "Gems" },
	},
	-- Items ~ Backpacks
	{
		...
		offers = {
			{
				...
				count = 1,
				movable = true,
				description = "<i>It could be bought for Theons after the festivities of Tibia's 25th anniversary</i>\n\n",
			...
			},
			{
				...
				count = 1,
				movable = true,
				description = "<i>It weighs 3.00 oz less than normal backpacks, and it has 24 item spaces, which makes it a valuable item.</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				count = 1,
				movable = true,
				description = "<i>The Blossom Bag weighs 8.00 oz, making it just as light as a regular bag, but it has 24 item spaces.</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Galthens_Satchel.png" },
				name = "Galthen's Satchel",
				price = 280,
				itemtype = 36813,
				count = 1,
				movable = true,
				description = "<i>The original satchel in which Galthen once carried all his personal notes and research.</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
	...
	-- Items ~ Gems
	{
		icons = { "Category_Gems.png" },
		parent = "Items",
		name = "Gems",
		rookgaard = false,
		offers = {
			{
				icons = { "lesser_guardian_gem.png" },
				name = "Lesser Guardian Gem",
				price = 100,
				itemtype = 44602,
				count = 1,
				movable = true,
				description = "<i>Shines with the strength of knights</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "lesser_guardian_gem.png" },
			...
			{
				icons = { "lesser_marksman_gem.png" },
				name = "Lesser Marksman Gem",
				price = 100,
				itemtype = 44605,
				count = 1,
				movable = true,
				description = "<i>Shines with the accuracy of paladins</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "lesser_marksman_gem.png" },
			...
			{
				icons = { "lesser_sage_gem.png" },
				name = "Lesser Sage Gem",
				price = 100,
				itemtype = 44608,
				count = 1,
				movable = true,
				description = "<i>Shines with the power of sorcerers</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "lesser_sage_gem.png" },
			...
			{
				icons = { "lesser_mystic_gem.png" },
				name = "Lesser Mystic Gem",
				price = 100,
				itemtype = 44611,
				count = 1,
				movable = true,
				description = "<i>Shines with the wisdom of druids</i>\n\n",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "lesser_mystic_gem.png" },
			...
			{
				icons = { "greater_guardian_gem.png" },
			...
			{
				icons = { "greater_marksman_gem.png" },
